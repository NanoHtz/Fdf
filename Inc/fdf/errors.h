...
/*   Updated: 2025/04/02 13:21:19 by fgalvez-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define FD_ERROR "function read_data : Use archives in maps/archive.fdf\n"
# define MEMORY_ERROR_R "function read_data : Error: Invalid map data.\n"
# define USAGE "Eroor: use only two arguments. Usage: ./fdf maps/archive.fdf"
